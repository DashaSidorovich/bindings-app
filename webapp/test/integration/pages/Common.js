sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/bindingsApp/app", ".html");
		...
		return Opa5.extend("zjblessons.bindingsApp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/bindingsApp/localService/mockserver"], function (mockserver) {
